...
<head>
<meta charset="UTF-8">
<title>List Appointment Record | JuzCare</title>
				...
				<div class="appointment-card">
					...
					<div class="appointment-action">
						<a
							...
							class="btn-view" title="View" style="text-decoration: none;">
							<i class="fas fa-eye"></i>
						</a> <span data-bs-toggle="tooltip" data-bs-placement="top"
							title="${apt.pastAppointment ? 'Cannot delete: appointment date is past' : 'Delete Appointment'}">
							<button class="btn-delete" data-id="${apt.appointmentID}"
								<c:if test="${apt.pastAppointment}">disabled</c:if>>
